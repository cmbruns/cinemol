...
rasmol_bright_brown = from_hex("#802828")
rasmol_bright_deep_pink = from_hex("#FA1691")
rasmol_bright_orange = from_hex("#FFAA00")
rasmol_bright_sky_blue = from_hex("#87CEE6")
rasmol_dark_gray = from_hex("#808090")
rasmol_dark_grey = rasmol_dark_gray
rasmol_deep_pink = from_hex("#FF1493")
rasmol_light_gray = from_hex("#C8C8C8")
rasmol_light_grey = rasmol_light_gray
rasmol_purple = from_hex("#A020F0")
rasmol_red = from_hex('#F00000')
rasmol_sky_blue = from_hex("#8F8FFF")
rasmol_yellow = from_hex("#FFC832")
red = from_hex("#ff0000")
...
class ColorByElement(object):
    ...
    def __init__(self):
        self.default_color = rasmol_deep_pink
        self._colors = dict()
...
class ColorByRasmolCpk(ColorByElement):
    def __init__(self):
        ...
        self._add(element.carbon, rasmol_light_gray)
        self._add(element.nitrogen, rasmol_sky_blue)
        self._add(element.oxygen, rasmol_red)
        self._add(element.fluorine, goldenrod)
        self._add(element.sodium, blue)
        self._add(element.magnesium, forest_green)
        self._add(element.aluminum, rasmol_dark_gray)
        self._add(element.silicon, goldenrod)
        self._add(element.phosphorus, orange)      
        self._add(element.sulfur, rasmol_yellow)
        self._add(element.chlorine, lime)
        self._add(element.potassium, blue)
        self._add(element.calcium, rasmol_dark_gray)
        self._add(element.titanium, rasmol_dark_gray)
        self._add(element.chromium, rasmol_dark_gray)
        self._add(element.manganese, rasmol_dark_gray)
        ...
        self._add(element.silver, rasmol_dark_gray)
        self._add(element.iodine, rasmol_purple)
...
class ColorByRasmolCpkNewLighter(ColorByRasmolCpk):
    def __init__(self):
        ...
        # self.default_color = rasmol_bright_deep_pink
        ...
        self._add(element.phosphorus, rasmol_bright_orange)      
        ...
        self._add(element.iron, rasmol_bright_orange)      
        self._add(element.nickel, rasmol_bright_brown)      
        self._add(element.copper, rasmol_bright_brown)      
        self._add(element.zinc, rasmol_bright_brown)      
        self._add(element.bromine, rasmol_bright_brown)      
        self._add(element.silver, dim_gray)
        self._add(element.barium, rasmol_bright_orange)      
